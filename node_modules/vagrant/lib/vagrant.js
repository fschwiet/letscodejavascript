...
var run = function(args, cb) {
    ...
    config(function(err, cwd) {
        ...
        function logData(data) {
            if (exports.consoleLogFile !== null ) {
                fs.appendFile(exports.consoleLogFile, data, { encoding: 'utf8'}, function(err) {
                });
            }
        }
        ...
        child.on('exit', function(code) {
            ...
            var lineSplitRegex = /(?:\r)?\n/;
            stdout = stdout.split(lineSplitRegex);

            if (code) {
                cb("Vagrant exited with code: " + code + ", stderr: " + stderr, stdout);
